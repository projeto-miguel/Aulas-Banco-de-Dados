...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Ago-2022 às 14:08
...
INSERT INTO `compra` (`nf`, `data_compra`, `id_cliente`, `codigo_produto`) VALUES
...
INSERT INTO `produto` (`codigo_produto`, `nome_produto`, `cor`, `preco`) VALUES
(1, 'MEIA', 'BRANCA', '8.00'),
(2, 'LAPIS', 'PRETO', '8.00'),
...
ALTER TABLE `compra`
  ...
  ADD CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`codigo_produto`) REFERENCES `produto` (`codigo_produto`);
--
...
('root', '[{\"db\":\"revisao\",\"table\":\"clientes\"},{\"db\":\"revisao\",\"table\":\"compras\"},{\"db\":\"compra\",\"table\":\"cliente\"}]');
...
('root', '2022-08-19 10:40:38', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
